...
<section>
    ...
    <table class="full-page-table">
        ...
        <tr>
            ...
            <td>
                <button class="book-button" onclick="location.href='CancelAdminServlet?id=<%=book.getDormitoryID()%>'">删除预约</button>
            </td>
            <td>
                <button class="book-button" onclick="location.href='AcceptAdminServlet?id=<%=book.getDormitoryID()%>'">同意预约</button>
            </td>
        </tr>
        <%
            }
