...
<table class="full-page-table">
    ...
    <tr>
        ...
        <td>
            <button class="book-button" onclick="location.href='CancelServlet?id=<%=book.getDormitoryID()%>'">取消预约</button>
        </td>
        <td>
            <button class="book-button" onclick="location.href='SelectAdmin1?id=<%=book.getDormitoryID()%>'">查找管理员</button>
        </td>
    </tr>
    <%
        }
