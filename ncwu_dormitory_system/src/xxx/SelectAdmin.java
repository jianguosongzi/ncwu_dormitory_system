...
public class SelectAdmin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (idString != null && !idString.isEmpty()) {
            try {
                int AdminID = Integer.parseInt(idString);
                ...
                try {
                        ...
                        if (rs.next()) {
                            ...
                            request.getRequestDispatcher("SelectAdminResult.jsp").forward(request, response); // 转发到search-results.jsp页面
                            ...
                            System.out.println("没有找到匹配的管理员记录");
                        }
